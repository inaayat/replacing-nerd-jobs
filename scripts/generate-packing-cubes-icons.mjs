#!/usr/bin/env node
/**
 * One-off: render packing-cubes/icons/app-icon.svg to the PNG sizes the web
 ...
 *
 *   npm install --no-save sharp && node scripts/generate-packing-cubes-icons.mjs
 */
...
const dir = join(root, 'packing-cubes/icons');
