...
video links preview on the card (Pinterest as a picture, never play; TikTok,
Instagram Reels, and YouTube behind play, using each site’s embed). Thumbnails
unfurl through `/api/wd-unfurl` on the same `api/wedding.js` function.
